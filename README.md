...
* [MadronaLib](https://github.com/madronalabs/madronalib) ⭐ 335 | 🐛 1 | 🌐 C++ | 📅 2026-08-22 - Randy Jones' DSP library, which is awesome because it is all designed for SIMD processing.
...
* [essentia](https://github.com/MTG/essentia) ⭐ 3,701 | 🐛 425 | 🌐 C++ | 📅 2026-07-22 - Essentia is a huge collection of MIR algorithms that you can use to extract high and low level features from audio. AGPL3 license. Somewhat painful to build cross-platform.
...
* [Webkit's Web Audio API](https://github.com/WebKit/WebKit/tree/main/Source/WebCore/Modules/webaudio) ⭐ 10,095 | 🐛 2,602 | 🌐 JavaScript | 📅 2026-08-25 - This is the C++ code for WebKit's implementation of the Web Audio API, as used in Safari.
* [supercollider](https://github.com/supercollider/supercollider) ⭐ 6,701 | 🐛 1,093 | 🌐 C++ | 📅 2026-08-20 - Likewise, but make sure you look at the scsynth part for DSP stuff.
...
* [tracktion engine](https://github.com/Tracktion/tracktion_engine) ⭐ 1,429 | 🐛 38 | 🌐 C++ | 📅 2026-08-24 - Source code for an entire DAW engine, using modern C++. An amazing resource for learning all sorts of things including how to structure and architect large audio projects. GPL/Commercial license.
