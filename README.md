...
* [CPLUG](https://github.com/Tremus/CPLUG) ⭐ 196 | 🐛 7 | 🌐 C | 📅 2026-09-22 - A smart new plug-in abstraction in C that targets VST3, AUv2, CLAP and Standalone formats on desktop. It's very new but a nice clean and minimal way to target multiple formats producing tiny binaries. Also includes hot reloading capabilities for the standalone targets.
...
* [Elements](https://github.com/cycfi/elements) ⭐ 3,721 | 🐛 41 | 🌐 C++ | 📅 2026-09-17 - A very promising UI framework for audio software using modern C++.
* [VSTGUI](https://github.com/steinbergmedia/vstgui) ⭐ 1,095 | 🐛 38 | 🌐 C++ | 📅 2026-09-06 - VSTGUI is Steinberg's cross-platform UI framework for audio plug-ins. It is released under a BSD licence, it's an impressive piece of work and many plug-in developers use it for their products.
...
* [Spatial Audio Framework](https://github.com/leomccormack/Spatial_Audio_Framework) ⭐ 751 | 🐛 4 | 🌐 C | 📅 2026-05-30 - Another excellent library for ambisonics and other spatial audio related processing
...
* [MadronaLib](https://github.com/madronalabs/madronalib) ⭐ 336 | 🐛 1 | 🌐 C++ | 📅 2026-09-22 - Randy Jones' DSP library, which is awesome because it is all designed for SIMD processing.
...
* [essentia](https://github.com/MTG/essentia) ⭐ 3,735 | 🐛 439 | 🌐 C++ | 📅 2026-09-21 - Essentia is a huge collection of MIR algorithms that you can use to extract high and low level features from audio. AGPL3 license. Somewhat painful to build cross-platform.
...
* [Matplotlib-cpp](https://github.com/lava/matplotlib-cpp) ⭐ 4,767 | 🐛 223 | 🌐 C++ | 📅 2023-11-21 - A C++ interface to the matplotlib python plotting tool. Allows you to visualize algorithms using the same code that you can use in production.
...
* [surge](https://github.com/surge-synthesizer/surge) ⭐ 4,022 | 🐛 166 | 🌐 C | 📅 2026-09-18 - Surge was an excellent product which has been open sourced and is now being maintained and continually improved by the surge-synth team, with a new JUCE UI.
* [vital](https://github.com/mtytel/vital) ⭐ 2,143 | 🐛 43 | 🌐 C++ | 📅 2023-05-25 - Vital is a very succesful wavetable synth with a slick interface done using the GPU. Amazing that a project like this can be open source!
...
* [Webkit's Web Audio API](https://github.com/WebKit/WebKit/tree/main/Source/WebCore/Modules/webaudio) ⭐ 10,173 | 🐛 2,713 | 🌐 JavaScript | 📅 2026-09-22 - This is the C++ code for WebKit's implementation of the Web Audio API, as used in Safari.
* [supercollider](https://github.com/supercollider/supercollider) ⭐ 6,742 | 🐛 1,088 | 🌐 C++ | 📅 2026-09-22 - Likewise, but make sure you look at the scsynth part for DSP stuff.
* [BespokeSynth](https://github.com/BespokeSynth/BespokeSynth) ⭐ 4,723 | 🐛 354 | 🌐 C++ | 📅 2026-09-18 - A pretty amazing modular synth/composition environment with nice real-time visualisation, loads of modules, and lots of flexibility
...
* [csound](https://github.com/csound/csound) ⭐ 1,506 | 🐛 48 | 🌐 C | 📅 2026-09-22 - CSound is still going strong after many years. It can also be used as an embeddable DSP library. There is a [Web IDE](https://ide.csound.com), which is a great way to play with interesting scores/orchestras/UDOs that you find on the web and [Cabbage](https://cabbageaudio.com/) lets you make plug-ins based on CSound orchestras.
* [tracktion engine](https://github.com/Tracktion/tracktion_engine) ⭐ 1,445 | 🐛 36 | 🌐 C++ | 📅 2026-09-22 - Source code for an entire DAW engine, using modern C++. An amazing resource for learning all sorts of things including how to structure and architect large audio projects. GPL/Commercial license.
...
* [ONNXRuntime](https://github.com/microsoft/onnxruntime) ⭐ 21,909 | 🐛 1,729 | 🌐 C++ | 📅 2026-09-22 - Microsoft's ONNX Runtime is a ML inference engine that is well documented, performant, and customizable. [Here](https://github.com/olilarkin/iPlug2OnnxRuntime) ⭐ 37 | 🐛 0 | 🌐 Python | 📅 2023-12-02 is an iPlug2 example that I prepared that integrates onnxruntime into an audio plugin, using [ort-builder](https://github.com/olilarkin/ort-builder) ⭐ 78 | 🐛 6 | 🌐 C++ | 📅 2025-04-22 - another project that I made in order to build custom, slimmed down static libraries for the onnxruntime
* [NeuralAmpModeler](https://github.com/sdatkinson/neural-amp-modeler) ⭐ 3,048 | 🐛 33 | 🌐 Python | 📅 2026-08-23 - A similar project, which is also very cool - plug-in built with iPlug2!
* [RTNeural](https://github.com/jatinchowdhury18/RTNeural) ⭐ 844 | 🐛 19 | 🌐 C++ | 📅 2026-08-20 - A library designed for realtime inference of Neural Network models with audio in mind. Very small when compared to linking a library like OnnxRuntime or libtensorflow.
...
* [mutable instruments](https://github.com/pichenettes/eurorack) ⭐ 3,178 | 🐛 7 | 🌐 C++ | 📅 2023-12-13 - Emilie Gillet's work is inspirational. The code has been [ported to VCVRack](https://github.com/VCVRack/AudibleInstruments/tree/master/src) ⭐ 450 | 🐛 54 | 🌐 C++ | 📅 2023-09-14 and to some nice [iOS AUv3s](https://github.com/boourns/Spectrum) ⭐ 37 | 🐛 12 | 🌐 C++ | 📅 2021-03-16
