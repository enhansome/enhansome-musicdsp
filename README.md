...
* [DPF](https://github.com/DISTRHO/DPF) ⭐ 852 | 🐛 78 | 🌐 C++ | 📅 2026-08-17 - Distrho Plug-in Framework is a nice C++ plug-in framework by falkTX, supporting lots of Linux formats.
...
* [Elements](https://github.com/cycfi/elements) ⭐ 3,719 | 🐛 41 | 🌐 C++ | 📅 2026-06-13 - A very promising UI framework for audio software using modern C++.
...
* [Q](https://github.com/cycfi/Q) ⭐ 1,417 | 🐛 0 | 🌐 C++ | 📅 2026-08-16 - A very nice looking modern C++ DSP library with concise examples
* [Spatial Audio Framework](https://github.com/leomccormack/Spatial_Audio_Framework) ⭐ 743 | 🐛 3 | 🌐 C | 📅 2026-05-30 - Another excellent library for ambisonics and other spatial audio related processing
...
* [essentia](https://github.com/MTG/essentia) ⭐ 3,696 | 🐛 425 | 🌐 C++ | 📅 2026-07-22 - Essentia is a huge collection of MIR algorithms that you can use to extract high and low level features from audio. AGPL3 license. Somewhat painful to build cross-platform.
...
* [surge](https://github.com/surge-synthesizer/surge) ⭐ 3,967 | 🐛 179 | 🌐 C | 📅 2026-08-17 - Surge was an excellent product which has been open sourced and is now being maintained and continually improved by the surge-synth team, with a new JUCE UI.
* [vital](https://github.com/mtytel/vital) ⭐ 2,107 | 🐛 43 | 🌐 C++ | 📅 2023-05-25 - Vital is a very succesful wavetable synth with a slick interface done using the GPU. Amazing that a project like this can be open source!
...
* [Webkit's Web Audio API](https://github.com/WebKit/WebKit/tree/main/Source/WebCore/Modules/webaudio) ⭐ 10,077 | 🐛 2,546 | 🌐 JavaScript | 📅 2026-08-17 - This is the C++ code for WebKit's implementation of the Web Audio API, as used in Safari.
* [supercollider](https://github.com/supercollider/supercollider) ⭐ 6,692 | 🐛 1,092 | 🌐 C++ | 📅 2026-08-17 - Likewise, but make sure you look at the scsynth part for DSP stuff.
* [BespokeSynth](https://github.com/BespokeSynth/BespokeSynth) ⭐ 4,690 | 🐛 354 | 🌐 C++ | 📅 2026-07-29 - A pretty amazing modular synth/composition environment with nice real-time visualisation, loads of modules, and lots of flexibility
...
* [dexed](https://github.com/asb2m10/dexed) ⭐ 3,466 | 🐛 80 | 🌐 C++ | 📅 2026-07-25 - Dexed is a JUCE frontend to [Raph Levien's "Music Synthesier For Android"](https://github.com/google/music-synthesizer-for-android) ⚠️ Archived, which is an excellent DX7 emulation. Also [ported to work on the web as a WebAudioModule](http://www.webaudiomodules.org/wamsynths/dexed)
* [AudioKit SynthOne](https://github.com/AudioKit/AudioKitSynthOne) ⭐ 1,785 | 🐛 26 | 🌐 Swift | 📅 2022-03-14 - SynthOne is a great open source project built using Audiokit,  that will be very interesting to anyone looking to build an iOS synthesiser.
...
* [tracktion engine](https://github.com/Tracktion/tracktion_engine) ⭐ 1,426 | 🐛 38 | 🌐 C++ | 📅 2026-08-03 - Source code for an entire DAW engine, using modern C++. An amazing resource for learning all sorts of things including how to structure and architect large audio projects. GPL/Commercial license.
* [AirWindows Plugins](https://github.com/airwindows/airwindows) ⭐ 1,201 | 🐛 33 | 🌐 C++ | 📅 2026-08-16 - A large collection of GUI-less plug-ins open source but supported via patreon [see airwindows site](http://www.airwindows.com/)
* [puredata](http://msp.ucsd.edu/software.html) - Pd is a really nice cross platform dataflow programming environment. Also check out [libpd](https://github.com/libpd), which you can use as an embeddable DSP runtime in your C++ audio plug-in etc. [Camomille](https://github.com/pierreguillot/Camomile) ⭐ 989 | 🐛 36 | 🌐 C++ | 📅 2024-02-26 combines libpd with JUCE to let you make plug-ins based on Pd patches. [plugdata](https://github.com/plugdata-team/plugdata) ⭐ 2,306 | 🐛 239 | 🌐 C | 📅 2026-06-19 is an excellent new effort to make PD run as a plug-in with a fresh new UI built with JUCE.
* [choc](https://github.com/Tracktion/choc) ⭐ 854 | 🐛 15 | 🌐 C++ | 📅 2026-08-16 - From the creator of JUCE comes CHOC, an ISC licensed library of Classy Header-Only Classes. Including some useful audio related utilities
...
* [ONNXRuntime](https://github.com/microsoft/onnxruntime) ⭐ 21,396 | 🐛 1,573 | 🌐 C++ | 📅 2026-08-17 - Microsoft's ONNX Runtime is a ML inference engine that is well documented, performant, and customizable. [Here](https://github.com/olilarkin/iPlug2OnnxRuntime) ⭐ 37 | 🐛 0 | 🌐 Python | 📅 2023-12-02 is an iPlug2 example that I prepared that integrates onnxruntime into an audio plugin, using [ort-builder](https://github.com/olilarkin/ort-builder) ⭐ 78 | 🐛 6 | 🌐 C++ | 📅 2025-04-22 - another project that I made in order to build custom, slimmed down static libraries for the onnxruntime
* [NeuralAmpModeler](https://github.com/sdatkinson/neural-amp-modeler) ⭐ 2,952 | 🐛 32 | 🌐 Python | 📅 2026-07-20 - A similar project, which is also very cool - plug-in built with iPlug2!
...
* [mutable instruments](https://github.com/pichenettes/eurorack) ⭐ 3,158 | 🐛 6 | 🌐 C++ | 📅 2023-12-13 - Emilie Gillet's work is inspirational. The code has been [ported to VCVRack](https://github.com/VCVRack/AudibleInstruments/tree/master/src) ⭐ 449 | 🐛 54 | 🌐 C++ | 📅 2023-09-14 and to some nice [iOS AUv3s](https://github.com/boourns/Spectrum) ⭐ 36 | 🐛 12 | 🌐 C++ | 📅 2021-03-16
