...
* [DPF](https://github.com/DISTRHO/DPF) ⭐ 853 | 🐛 78 | 🌐 C++ | 📅 2026-08-22 - Distrho Plug-in Framework is a nice C++ plug-in framework by falkTX, supporting lots of Linux formats.
...
* [Elements](https://github.com/cycfi/elements) ⭐ 3,721 | 🐛 41 | 🌐 C++ | 📅 2026-06-13 - A very promising UI framework for audio software using modern C++.
...
* [PUGL](https://github.com/lv2/pugl) ⭐ 212 | 🐛 18 | 🌐 C | 📅 2026-04-15 - A cross platform GLFW-like solution that lets plug-in developers use OpenGL for their UIs

## DSP Libraries

* [Q](https://github.com/cycfi/Q) ⭐ 1,417 | 🐛 0 | 🌐 C++ | 📅 2026-08-22 - A very nice looking modern C++ DSP library with concise examples
* [Spatial Audio Framework](https://github.com/leomccormack/Spatial_Audio_Framework) ⭐ 741 | 🐛 4 | 🌐 C | 📅 2026-05-30 - Another excellent library for ambisonics and other spatial audio related processing
...
* [MadronaLib](https://github.com/madronalabs/madronalib) ⭐ 335 | 🐛 0 | 🌐 C++ | 📅 2026-08-22 - Randy Jones' DSP library, which is awesome because it is all designed for SIMD processing.
...
* [essentia](https://github.com/MTG/essentia) ⭐ 3,698 | 🐛 425 | 🌐 C++ | 📅 2026-07-22 - Essentia is a huge collection of MIR algorithms that you can use to extract high and low level features from audio. AGPL3 license. Somewhat painful to build cross-platform.
...
* [surge](https://github.com/surge-synthesizer/surge) ⭐ 3,977 | 🐛 179 | 🌐 C | 📅 2026-08-17 - Surge was an excellent product which has been open sourced and is now being maintained and continually improved by the surge-synth team, with a new JUCE UI.
...
* [Webkit's Web Audio API](https://github.com/WebKit/WebKit/tree/main/Source/WebCore/Modules/webaudio) ⭐ 10,092 | 🐛 2,571 | 🌐 JavaScript | 📅 2026-08-22 - This is the C++ code for WebKit's implementation of the Web Audio API, as used in Safari.
* [supercollider](https://github.com/supercollider/supercollider) ⭐ 6,697 | 🐛 1,091 | 🌐 C++ | 📅 2026-08-20 - Likewise, but make sure you look at the scsynth part for DSP stuff.
...
* [ONNXRuntime](https://github.com/microsoft/onnxruntime) ⭐ 21,598 | 🐛 1,600 | 🌐 C++ | 📅 2026-08-22 - Microsoft's ONNX Runtime is a ML inference engine that is well documented, performant, and customizable. [Here](https://github.com/olilarkin/iPlug2OnnxRuntime) ⭐ 37 | 🐛 0 | 🌐 Python | 📅 2023-12-02 is an iPlug2 example that I prepared that integrates onnxruntime into an audio plugin, using [ort-builder](https://github.com/olilarkin/ort-builder) ⭐ 78 | 🐛 6 | 🌐 C++ | 📅 2025-04-22 - another project that I made in order to build custom, slimmed down static libraries for the onnxruntime
* [NeuralAmpModeler](https://github.com/sdatkinson/neural-amp-modeler) ⭐ 2,975 | 🐛 33 | 🌐 Python | 📅 2026-07-20 - A similar project, which is also very cool - plug-in built with iPlug2!
