...
* [DPF](https://github.com/DISTRHO/DPF) ⭐ 859 | 🐛 80 | 🌐 C++ | 📅 2026-08-22 - Distrho Plug-in Framework is a nice C++ plug-in framework by falkTX, supporting lots of Linux formats.
...
* [Elements](https://github.com/cycfi/elements) ⭐ 3,716 | 🐛 41 | 🌐 C++ | 📅 2026-09-05 - A very promising UI framework for audio software using modern C++.
...
* [Q](https://github.com/cycfi/Q) ⭐ 1,421 | 🐛 0 | 🌐 C++ | 📅 2026-09-02 - A very nice looking modern C++ DSP library with concise examples
...
* [surge](https://github.com/surge-synthesizer/surge) ⭐ 3,997 | 🐛 173 | 🌐 C | 📅 2026-09-05 - Surge was an excellent product which has been open sourced and is now being maintained and continually improved by the surge-synth team, with a new JUCE UI.
...
* [Webkit's Web Audio API](https://github.com/WebKit/WebKit/tree/main/Source/WebCore/Modules/webaudio) ⭐ 10,123 | 🐛 2,643 | 🌐 JavaScript | 📅 2026-09-05 - This is the C++ code for WebKit's implementation of the Web Audio API, as used in Safari.
* [supercollider](https://github.com/supercollider/supercollider) ⭐ 6,714 | 🐛 1,095 | 🌐 C++ | 📅 2026-08-20 - Likewise, but make sure you look at the scsynth part for DSP stuff.
...
* [csound](https://github.com/csound/csound) ⭐ 1,505 | 🐛 31 | 🌐 C | 📅 2026-09-05 - CSound is still going strong after many years. It can also be used as an embeddable DSP library. There is a [Web IDE](https://ide.csound.com), which is a great way to play with interesting scores/orchestras/UDOs that you find on the web and [Cabbage](https://cabbageaudio.com/) lets you make plug-ins based on CSound orchestras.
* [tracktion engine](https://github.com/Tracktion/tracktion_engine) ⭐ 1,441 | 🐛 37 | 🌐 C++ | 📅 2026-09-03 - Source code for an entire DAW engine, using modern C++. An amazing resource for learning all sorts of things including how to structure and architect large audio projects. GPL/Commercial license.
...
* [obxd](https://github.com/2DaT/Obxd) ⭐ 137 | 🐛 2 | 🌐 C++ | 📅 2014-10-27 - OBxd  is a great sounding oberheim emulation plug-in, written with JUCE. [DiscoDSP have updated it](https://github.com/reales/OB-Xd) ⭐ 258 | 🐛 0 | 📅 2026-08-18, and it has also been [ported to work on the web as a WebAudioModule](http://www.webaudiomodules.org/wamsynths/obxd)
...
* [ONNXRuntime](https://github.com/microsoft/onnxruntime) ⭐ 21,767 | 🐛 1,696 | 🌐 C++ | 📅 2026-09-05 - Microsoft's ONNX Runtime is a ML inference engine that is well documented, performant, and customizable. [Here](https://github.com/olilarkin/iPlug2OnnxRuntime) ⭐ 37 | 🐛 0 | 🌐 Python | 📅 2023-12-02 is an iPlug2 example that I prepared that integrates onnxruntime into an audio plugin, using [ort-builder](https://github.com/olilarkin/ort-builder) ⭐ 78 | 🐛 6 | 🌐 C++ | 📅 2025-04-22 - another project that I made in order to build custom, slimmed down static libraries for the onnxruntime
* [NeuralAmpModeler](https://github.com/sdatkinson/neural-amp-modeler) ⭐ 3,015 | 🐛 32 | 🌐 Python | 📅 2026-08-23 - A similar project, which is also very cool - plug-in built with iPlug2!
...
* [mutable instruments](https://github.com/pichenettes/eurorack) ⭐ 3,169 | 🐛 6 | 🌐 C++ | 📅 2023-12-13 - Emilie Gillet's work is inspirational. The code has been [ported to VCVRack](https://github.com/VCVRack/AudibleInstruments/tree/master/src) ⭐ 449 | 🐛 54 | 🌐 C++ | 📅 2023-09-14 and to some nice [iOS AUv3s](https://github.com/boourns/Spectrum) ⭐ 37 | 🐛 12 | 🌐 C++ | 📅 2021-03-16
