...
* [DPF](https://github.com/DISTRHO/DPF) ⭐ 857 | 🐛 79 | 🌐 C++ | 📅 2026-08-22 - Distrho Plug-in Framework is a nice C++ plug-in framework by falkTX, supporting lots of Linux formats.
...
* [VSTGUI](https://github.com/steinbergmedia/vstgui) ⭐ 1,088 | 🐛 36 | 🌐 C++ | 📅 2026-08-09 - VSTGUI is Steinberg's cross-platform UI framework for audio plug-ins. It is released under a BSD licence, it's an impressive piece of work and many plug-in developers use it for their products.
...
* [MadronaLib](https://github.com/madronalabs/madronalib) ⭐ 335 | 🐛 1 | 🌐 C++ | 📅 2026-08-26 - Randy Jones' DSP library, which is awesome because it is all designed for SIMD processing.
...
* [essentia](https://github.com/MTG/essentia) ⭐ 3,706 | 🐛 425 | 🌐 C++ | 📅 2026-07-22 - Essentia is a huge collection of MIR algorithms that you can use to extract high and low level features from audio. AGPL3 license. Somewhat painful to build cross-platform.
* [audioflux](https://github.com/libAudioFlux/audioFlux) ⭐ 3,351 | 🐛 16 | 🌐 C | 📅 2026-03-06 - AudioFlux is a new-kid-on the block and some what similar but looks designed for deep learning, it looks very promising and has a liberal (MIT) license.
...
* [surge](https://github.com/surge-synthesizer/surge) ⭐ 3,980 | 🐛 178 | 🌐 C | 📅 2026-08-17 - Surge was an excellent product which has been open sourced and is now being maintained and continually improved by the surge-synth team, with a new JUCE UI.
...
* [Webkit's Web Audio API](https://github.com/WebKit/WebKit/tree/main/Source/WebCore/Modules/webaudio) ⭐ 10,097 | 🐛 2,614 | 🌐 JavaScript | 📅 2026-08-27 - This is the C++ code for WebKit's implementation of the Web Audio API, as used in Safari.
* [supercollider](https://github.com/supercollider/supercollider) ⭐ 6,704 | 🐛 1,093 | 🌐 C++ | 📅 2026-08-20 - Likewise, but make sure you look at the scsynth part for DSP stuff.
* [BespokeSynth](https://github.com/BespokeSynth/BespokeSynth) ⭐ 4,698 | 🐛 356 | 🌐 C++ | 📅 2026-08-27 - A pretty amazing modular synth/composition environment with nice real-time visualisation, loads of modules, and lots of flexibility
...
* [csound](https://github.com/csound/csound) ⭐ 1,503 | 🐛 29 | 🌐 C | 📅 2026-08-19 - CSound is still going strong after many years. It can also be used as an embeddable DSP library. There is a [Web IDE](https://ide.csound.com), which is a great way to play with interesting scores/orchestras/UDOs that you find on the web and [Cabbage](https://cabbageaudio.com/) lets you make plug-ins based on CSound orchestras.
* [tracktion engine](https://github.com/Tracktion/tracktion_engine) ⭐ 1,433 | 🐛 35 | 🌐 C++ | 📅 2026-08-26 - Source code for an entire DAW engine, using modern C++. An amazing resource for learning all sorts of things including how to structure and architect large audio projects. GPL/Commercial license.
...
* [ONNXRuntime](https://github.com/microsoft/onnxruntime) ⭐ 21,656 | 🐛 1,641 | 🌐 C++ | 📅 2026-08-27 - Microsoft's ONNX Runtime is a ML inference engine that is well documented, performant, and customizable. [Here](https://github.com/olilarkin/iPlug2OnnxRuntime) ⭐ 37 | 🐛 0 | 🌐 Python | 📅 2023-12-02 is an iPlug2 example that I prepared that integrates onnxruntime into an audio plugin, using [ort-builder](https://github.com/olilarkin/ort-builder) ⭐ 78 | 🐛 6 | 🌐 C++ | 📅 2025-04-22 - another project that I made in order to build custom, slimmed down static libraries for the onnxruntime
* [NeuralAmpModeler](https://github.com/sdatkinson/neural-amp-modeler) ⭐ 2,987 | 🐛 32 | 🌐 Python | 📅 2026-08-23 - A similar project, which is also very cool - plug-in built with iPlug2!
...
* [mutable instruments](https://github.com/pichenettes/eurorack) ⭐ 3,165 | 🐛 6 | 🌐 C++ | 📅 2023-12-13 - Emilie Gillet's work is inspirational. The code has been [ported to VCVRack](https://github.com/VCVRack/AudibleInstruments/tree/master/src) ⭐ 449 | 🐛 54 | 🌐 C++ | 📅 2023-09-14 and to some nice [iOS AUv3s](https://github.com/boourns/Spectrum) ⭐ 36 | 🐛 12 | 🌐 C++ | 📅 2021-03-16
