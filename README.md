...
* [Spatial Audio Framework](https://github.com/leomccormack/Spatial_Audio_Framework) ⭐ 740 | 🐛 3 | 🌐 C | 📅 2026-05-30 - Another excellent library for ambisonics and other spatial audio related processing
...
* [Mach1 Spatial SDK](https://github.com/Mach1Studios/m1-sdk) ⭐ 65 | 🐛 1 | 🌐 C | 📅 2026-03-06 - Vector based multichannel & spatial audio APIs for customizing multichannel or spatial audio pipelines & tools and agnostically playback any spatial, surround soundfields.
...
* [Webkit's Web Audio API](https://github.com/WebKit/WebKit/tree/main/Source/WebCore/Modules/webaudio) ⭐ 10,062 | 🐛 2,521 | 🌐 JavaScript | 📅 2026-08-13 - This is the C++ code for WebKit's implementation of the Web Audio API, as used in Safari.
* [supercollider](https://github.com/supercollider/supercollider) ⭐ 6,685 | 🐛 1,094 | 🌐 C++ | 📅 2026-08-12 - Likewise, but make sure you look at the scsynth part for DSP stuff.
...
* [destroyfx](https://github.com/sophiapoirier/destroyfx) ⭐ 264 | 🐛 7 | 🌐 C++ | 📅 2026-07-15 - A brilliant collection of open source plug-ins that are very original have been around since the dawn of VST.
