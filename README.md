...
* [DPF](https://github.com/DISTRHO/DPF) ⭐ 853 | 🐛 78 | 🌐 C++ | 📅 2026-08-17 - Distrho Plug-in Framework is a nice C++ plug-in framework by falkTX, supporting lots of Linux formats.
...
* [VSTGUI](https://github.com/steinbergmedia/vstgui) ⭐ 1,086 | 🐛 35 | 🌐 C++ | 📅 2026-08-09 - VSTGUI is Steinberg's cross-platform UI framework for audio plug-ins. It is released under a BSD licence, it's an impressive piece of work and many plug-in developers use it for their products.
...
* [Q](https://github.com/cycfi/Q) ⭐ 1,417 | 🐛 0 | 🌐 C++ | 📅 2026-08-20 - A very nice looking modern C++ DSP library with concise examples
...
* [MadronaLib](https://github.com/madronalabs/madronalib) ⭐ 335 | 🐛 2 | 🌐 C++ | 📅 2026-08-19 - Randy Jones' DSP library, which is awesome because it is all designed for SIMD processing.
...
* [surge](https://github.com/surge-synthesizer/surge) ⭐ 3,974 | 🐛 179 | 🌐 C | 📅 2026-08-17 - Surge was an excellent product which has been open sourced and is now being maintained and continually improved by the surge-synth team, with a new JUCE UI.
* [vital](https://github.com/mtytel/vital) ⭐ 2,111 | 🐛 43 | 🌐 C++ | 📅 2023-05-25 - Vital is a very succesful wavetable synth with a slick interface done using the GPU. Amazing that a project like this can be open source!
...
* [Webkit's Web Audio API](https://github.com/WebKit/WebKit/tree/main/Source/WebCore/Modules/webaudio) ⭐ 10,085 | 🐛 2,533 | 🌐 JavaScript | 📅 2026-08-20 - This is the C++ code for WebKit's implementation of the Web Audio API, as used in Safari.
...
* [BespokeSynth](https://github.com/BespokeSynth/BespokeSynth) ⭐ 4,692 | 🐛 356 | 🌐 C++ | 📅 2026-08-18 - A pretty amazing modular synth/composition environment with nice real-time visualisation, loads of modules, and lots of flexibility
...
* [ONNXRuntime](https://github.com/microsoft/onnxruntime) ⭐ 21,410 | 🐛 1,591 | 🌐 C++ | 📅 2026-08-20 - Microsoft's ONNX Runtime is a ML inference engine that is well documented, performant, and customizable. [Here](https://github.com/olilarkin/iPlug2OnnxRuntime) ⭐ 37 | 🐛 0 | 🌐 Python | 📅 2023-12-02 is an iPlug2 example that I prepared that integrates onnxruntime into an audio plugin, using [ort-builder](https://github.com/olilarkin/ort-builder) ⭐ 78 | 🐛 6 | 🌐 C++ | 📅 2025-04-22 - another project that I made in order to build custom, slimmed down static libraries for the onnxruntime
* [NeuralAmpModeler](https://github.com/sdatkinson/neural-amp-modeler) ⭐ 2,969 | 🐛 32 | 🌐 Python | 📅 2026-07-20 - A similar project, which is also very cool - plug-in built with iPlug2!
* [RTNeural](https://github.com/jatinchowdhury18/RTNeural) ⭐ 837 | 🐛 18 | 🌐 C++ | 📅 2026-08-20 - A library designed for realtime inference of Neural Network models with audio in mind. Very small when compared to linking a library like OnnxRuntime or libtensorflow.
...
* [mutable instruments](https://github.com/pichenettes/eurorack) ⭐ 3,164 | 🐛 6 | 🌐 C++ | 📅 2023-12-13 - Emilie Gillet's work is inspirational. The code has been [ported to VCVRack](https://github.com/VCVRack/AudibleInstruments/tree/master/src) ⭐ 449 | 🐛 54 | 🌐 C++ | 📅 2023-09-14 and to some nice [iOS AUv3s](https://github.com/boourns/Spectrum) ⭐ 36 | 🐛 12 | 🌐 C++ | 📅 2021-03-16
