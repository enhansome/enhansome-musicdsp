...
* [CPLUG](https://github.com/Tremus/CPLUG) ⭐ 194 | 🐛 6 | 🌐 C | 📅 2026-08-04 - A smart new plug-in abstraction in C that targets VST3, AUv2, CLAP and Standalone formats on desktop. It's very new but a nice clean and minimal way to target multiple formats producing tiny binaries. Also includes hot reloading capabilities for the standalone targets.
...
* [Elements](https://github.com/cycfi/elements) ⭐ 3,718 | 🐛 41 | 🌐 C++ | 📅 2026-06-13 - A very promising UI framework for audio software using modern C++.
* [VSTGUI](https://github.com/steinbergmedia/vstgui) ⭐ 1,092 | 🐛 36 | 🌐 C++ | 📅 2026-08-30 - VSTGUI is Steinberg's cross-platform UI framework for audio plug-ins. It is released under a BSD licence, it's an impressive piece of work and many plug-in developers use it for their products.
...
* [Spatial Audio Framework](https://github.com/leomccormack/Spatial_Audio_Framework) ⭐ 745 | 🐛 4 | 🌐 C | 📅 2026-05-30 - Another excellent library for ambisonics and other spatial audio related processing
...
* [essentia](https://github.com/MTG/essentia) ⭐ 3,710 | 🐛 436 | 🌐 C++ | 📅 2026-08-27 - Essentia is a huge collection of MIR algorithms that you can use to extract high and low level features from audio. AGPL3 license. Somewhat painful to build cross-platform.
* [audioflux](https://github.com/libAudioFlux/audioFlux) ⭐ 3,356 | 🐛 16 | 🌐 C | 📅 2026-03-06 - AudioFlux is a new-kid-on the block and some what similar but looks designed for deep learning, it looks very promising and has a liberal (MIT) license.
...
* [Matplotlib-cpp](https://github.com/lava/matplotlib-cpp) ⭐ 4,772 | 🐛 223 | 🌐 C++ | 📅 2023-11-21 - A C++ interface to the matplotlib python plotting tool. Allows you to visualize algorithms using the same code that you can use in production.
...
* [surge](https://github.com/surge-synthesizer/surge) ⭐ 3,995 | 🐛 178 | 🌐 C | 📅 2026-09-03 - Surge was an excellent product which has been open sourced and is now being maintained and continually improved by the surge-synth team, with a new JUCE UI.
* [vital](https://github.com/mtytel/vital) ⭐ 2,122 | 🐛 43 | 🌐 C++ | 📅 2023-05-25 - Vital is a very succesful wavetable synth with a slick interface done using the GPU. Amazing that a project like this can be open source!
...
* [Webkit's Web Audio API](https://github.com/WebKit/WebKit/tree/main/Source/WebCore/Modules/webaudio) ⭐ 10,115 | 🐛 2,641 | 🌐 JavaScript | 📅 2026-09-03 - This is the C++ code for WebKit's implementation of the Web Audio API, as used in Safari.
...
* [BespokeSynth](https://github.com/BespokeSynth/BespokeSynth) ⭐ 4,704 | 🐛 353 | 🌐 C++ | 📅 2026-09-03 - A pretty amazing modular synth/composition environment with nice real-time visualisation, loads of modules, and lots of flexibility
...
* [tracktion engine](https://github.com/Tracktion/tracktion_engine) ⭐ 1,438 | 🐛 37 | 🌐 C++ | 📅 2026-09-03 - Source code for an entire DAW engine, using modern C++. An amazing resource for learning all sorts of things including how to structure and architect large audio projects. GPL/Commercial license.
...
* [ONNXRuntime](https://github.com/microsoft/onnxruntime) ⭐ 21,756 | 🐛 1,700 | 🌐 C++ | 📅 2026-09-03 - Microsoft's ONNX Runtime is a ML inference engine that is well documented, performant, and customizable. [Here](https://github.com/olilarkin/iPlug2OnnxRuntime) ⭐ 37 | 🐛 0 | 🌐 Python | 📅 2023-12-02 is an iPlug2 example that I prepared that integrates onnxruntime into an audio plugin, using [ort-builder](https://github.com/olilarkin/ort-builder) ⭐ 78 | 🐛 6 | 🌐 C++ | 📅 2025-04-22 - another project that I made in order to build custom, slimmed down static libraries for the onnxruntime
* [NeuralAmpModeler](https://github.com/sdatkinson/neural-amp-modeler) ⭐ 3,003 | 🐛 32 | 🌐 Python | 📅 2026-08-23 - A similar project, which is also very cool - plug-in built with iPlug2!
